      ...
      <section className="h-full bg-white w-75 rounded-lg border border-gray-300 shadow-sm px-4">
        ...
        <div>
          <ul className="flex flex-col gap-2">
            <li className="py-3 px-4  bg-teal-800 rounded-md text-white flex items-center cursor-pointer">
              <Squares2X2Icon className="h-6 w-6 mr-2" />
              Dashboard
            </li>
            <li className="py-3 px-4 hover:bg-stone-100 rounded-md flex items-center  cursor-pointer">
