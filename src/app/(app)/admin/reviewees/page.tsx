    ...
    <section>
      ...
      <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <button
          ...
          className="inline-flex w-fit cursor-pointer items-center gap-1.5 rounded bg-teal-600 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-teal-700"
        >
        ...
        <label className="relative block w-full sm:max-w-[275px]">
          ...
          <input
            ...
            className="h-10 w-full rounded-full border border-slate-200 bg-white pl-10 pr-4 text-sm outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-100"
          />
        </label>
      </div>
