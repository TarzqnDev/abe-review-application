...
## UI Guidelines
- Always rely on our Design Principles and Guidelines first before implementing any UIs: @DESIGN.md (Ignore if the file is not present)
- If the project have existed UI, follow the design system of it and incorporate guidelines in our Design Principles and Guidelines that is not opposing with the current design system of the ui in the project
...
## Notes
- The details of implemented features will be saved in @implemented.md (create it if it is not yet created)
- Save the other rules and preferences that the developer said while building this project in @implemented-rules.md (create it if it is not yet created)
- Always read the @implemented.md and @implemented-rules.md rules first so that you are aware of the already implemented features in this project and other rules and preferences of the developer